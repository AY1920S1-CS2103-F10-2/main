...
|`* * *` |user |add templates of grocery items |to keep track of what I want to have in my fridge
...
*Waste*: Groceries that have expired and have not been fully consumed.
